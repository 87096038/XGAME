...
function WeaponData:Init()
    ...
    self.Weapons[60004]={ID = 60004, preID = -1, cost = 0, PrefabPath=PathMgr.ResourcePath.Gun_Normal_Sniper_Rifle, PrefabName=PathMgr.NamePath.Gun_Normal_Sniper_Rifle, weaponType = Enum_WeaponType.normal_sniper_rifle, bulletType = Enum_BulletType.heavy, shootType = Enum_ShootType.single, name = "狙击枪", info = "一把普通的狙击枪。", basicDamage = 8, basicSpeed = 50, basicCD = 1, basicClipsAmmoCount = 4, basicReloadTime = 1, storeForceTime = 1, maxTimesCount = 2.5, }
end
