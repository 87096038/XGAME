...
namespace XLua.CSObjectWrap
{
    ...
    public class KeyValueWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			...
			System.Type type = typeof(KeyValue);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to KeyValue constructor!");
        ...
        static int _g_get_Key(RealStatePtr L)
        {
		    try {
                ...
                KeyValue gen_to_be_invoked = (KeyValue)translator.FastGetCSObj(L, 1);
