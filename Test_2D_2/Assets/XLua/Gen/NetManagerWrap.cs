...
namespace XLua.CSObjectWrap
{
    ...
    public class NetManagerWrap 
    {
        ...
        {
            return LuaAPI.luaL_error(L, "NetManager does not have a constructor!");
        }
		    ...
		    try {
                ...
                
                {
                    ...
                    int _port = LuaAPI.xlua_tointeger(L, 3);
                        ...
                        bool gen_ret = gen_to_be_invoked.Connect( _IP, _port );
        ...
        static int _m_Send(RealStatePtr L)
        {
		    try {
                ...
                {
                    byte _type = (byte)LuaAPI.xlua_tointeger(L, 2);
                    byte[] _data = LuaAPI.lua_tobytes(L, 3);
                    
                    gen_to_be_invoked.Send( _type, _data );
        ...
        static int _g_get_Instance(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			    translator.Push(L, NetManager.Instance);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
