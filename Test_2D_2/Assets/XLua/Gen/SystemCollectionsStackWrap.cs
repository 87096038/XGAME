        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					System.Collections.Stack gen_ret = new System.Collections.Stack();
				...
				if(LuaAPI.lua_gettop(L) == 2 && LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2))
				{
					...
					System.Collections.Stack gen_ret = new System.Collections.Stack(_initialCapacity);
					translator.Push(L, gen_ret);
				...
				if(LuaAPI.lua_gettop(L) == 2 && translator.Assignable<System.Collections.ICollection>(L, 2))
				{
					...
					System.Collections.Stack gen_ret = new System.Collections.Stack(_col);
					translator.Push(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    object _obj = translator.GetObject(L, 2, typeof(object));
                        ...
                        bool gen_ret = gen_to_be_invoked.Contains( _obj );
        ...
        static int _m_Peek(RealStatePtr L)
        {
		    try {
                ...
                
                {
                        ...
                        object gen_ret = gen_to_be_invoked.Peek(  );
                        translator.PushAny(L, gen_ret);
        ...
        static int _m_Pop(RealStatePtr L)
        {
		    try {
                ...
                
                {
                        ...
                        object gen_ret = gen_to_be_invoked.Pop(  );
                        translator.PushAny(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    System.Collections.Stack _stack = (System.Collections.Stack)translator.GetObject(L, 1, typeof(System.Collections.Stack));
                        ...
                        System.Collections.Stack gen_ret = System.Collections.Stack.Synchronized( _stack );
                        translator.Push(L, gen_ret);
